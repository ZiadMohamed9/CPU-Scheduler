...
public class FCFSSchedulingAlgorithm  implements SchedulingAlgorithm {
    ...
    public SchedulerResult schedule(List<Process> processes) {
        // Work on a copy of the list to avoid modifying the original Process objects' states directly
        // if they are to be reused by other algorithms or subsequent runs.
